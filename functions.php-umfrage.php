...
function anzeige_umfragen_aktuell($adm = 0)
{
    ...
    if ($adm)
    {
        ...
        echo "<TR><TD COLSPAN=3>".$f1."[$link]<BR/><BR/>".$f2."</TD></TR>";
    }
        ...
        else
        {
            ...
            while($row=mysql_fetch_object($result)) 
            {
                ...
                if ($bereich <> $row->um_bereich)
                {
                    if ($i <> 1)
                    {
                        echo "<TR><TD COLSPAN=3>".$f1."&nbsp;".$f2."</TR></TD>";
                    }
 
                    echo "<TR BGCOLOR=\"$farbe_tabelle_kopf2\"><TD COLSPAN=3><B>zum Thema: $row->um_bereich</B>".
                         "<TR><TD WIDTH=\"70%\">".$f1."<B>Frage</B>".$f2."</TD><TD WIDTH=\"15%\">".$f1."<B>Status</B>".$f2."</TD><TD WIDTH=\"15%\">".$f1."<B>endet</B>".$f2."</TD></TR>";
                ...
                echo "<TR BGCOLOR=\"$bgcolor\"><TD>".$f1.$row->um_frage.$f2."</TD><TD>".$f1.$link.$f2."</TD><TD>".$f1.$row->ende_umfrage.$f2."</TD></TR>\n";
        ...
        else
        {
            ...
            while($row=mysql_fetch_object($result)) 
            {
                ...
                if ($bereich <> $row->um_bereich)
                {
                    ...
                    echo "<TR BGCOLOR=\"$farbe_tabelle_kopf2\"><TD COLSPAN=3><B>zum Thema: $row->um_bereich</B>".
                         "<TR><TD WIDTH=\"70%\">".$f1."<B>Frage</B>".$f2."</TD><TD WIDTH=\"15%\">".$f1."<B>Status</B>".$f2."</TD><TD WIDTH=\"15%\">".$f1."<B>startet</B>".$f2."</TD></TR>";
                    $bereich = $row->um_bereich;
                }
                ...
                echo "<TR BGCOLOR=\"$bgcolor\"><TD>".$f1.$row->um_frage.$f2."</TD><TD>".$f1."geplant".$f2."</TD><TD>".$f1.$row->start_umfrage.$f2."</TD></TR>\n";
        ...
        else
        {
            ...
            while($row=mysql_fetch_object($result)) 
            {
                ...
                if ($bereich <> $row->um_bereich)
                {
                    ...
                    echo "<TR BGCOLOR=\"$farbe_tabelle_kopf2\"><TD COLSPAN=3><B>zum Thema: $row->um_bereich</B>".
                         "<TR><TD WIDTH=\"70%\">".$f1."<B>Frage</B>".$f2."</TD><TD WIDTH=\"15%\">".$f1."<B>Status</B>".$f2."</TD><TD WIDTH=\"15%\">".$f1."<B>endete</B>".$f2."</TD></TR>";
                    $bereich = $row->um_bereich;
                }
