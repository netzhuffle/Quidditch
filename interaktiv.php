...
<?php echo $stylesheet; ?>
	...
	if (!isset($o_raum_alt)) $o_raum_alt = -9;
	...
	echo "<FORM ACTION=\"".$chat_url."interaktiv.php\" NAME=form1 METHOD=POST>\n";
	...
	if (($u_level == "U" || $u_level == "G") && ($single_room_verhalten == "1")) $zahl = 0;
	...
	if ($u_level!="M") {
		echo "<INPUT TYPE=\"SUBMIT\" NAME=\"raum_submit\" VALUE=\"Go!\">&nbsp;</NOBR>".$f4."</TD>\n";
	} else {
		echo "<BR>&nbsp;".
			"<INPUT TYPE=\"SUBMIT\" NAME=\"raum_submit\" VALUE=\"Go!\">&nbsp;</NOBR>".$f4."</TD>\n".
			"</tr><tr>";
	};
