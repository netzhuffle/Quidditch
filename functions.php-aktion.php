...
function zeige_aktionen($aktion) {
	...
	foreach($a_wann as $a_wann_eintrag){
		echo "<TD ALIGN=\"CENTER\"><B>".$f1.$a_wann_eintrag.$f2."</B></TD>\n";
	}
	echo "</TR>\n";	
	...
	foreach($def_was as $def_was_eintrag){
		...
		echo "<TR BGCOLOR=\"$bgcolor\"><TD ALIGN=\"RIGHT\"><B>".$f1.$def_was_eintrag.$f2."</B></TD>\n";
		foreach($a_wann as $a_wann_eintrag){
	...
	echo "<TR BGCOLOR=\"$bgcolor\"><TD>&nbsp;</TD><TD ALIGN=\"right\" COLSPAN=4>".$f1.
